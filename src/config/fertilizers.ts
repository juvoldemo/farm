...
export const fertilizers: FertilizerDefinition[] = [
  ...
  {id:'premium',name:'Phân cao cấp',icon:'✨',description:'Giảm 25% thời gian còn lại.',priceGold:1200,reductionType:'percentage',reductionValue:25,maxUsesPerCrop:1},
  {id:'instant',name:'Phân siêu tốc',icon:'⚡',description:'Cây hoàn thành ngay lập tức.',priceGold:3000,reductionType:'instant',reductionValue:100,maxUsesPerCrop:1},
]
